    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-18 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {!user ? (
          ...
          <div className="relative group">
            ...
            <h2 className="w-10 h-10 flex items-center justify-center bg-orange-200 border-2 border-orange-600 rounded-full cursor-pointer">
              MC
            </h2>
            <ul className="hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-orange-200 py-2.5 w-30 rounded-md text-sm z-40">
              <li
      ...
      {open && (
        <div
          className={`${
            open ? "flex" : "hidden"
          } absolute top-[60px] left-0 w-full bg-white shadow-md py-6 flex-col items-center gap-2 px-5 text-sm md:hidden`}
        >
          <NavLink to="/" onClick={() => setOpen(false)}>
            Home
          </NavLink>
