  ...
  return (
    <div className="flex flex-col items-center rounded-2xl px-4 mx-2 mt-16 ">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mt-6">
        ...
        />
        <button className="flex items-center justify-center gap-2 group bg-orange-500 hover:bg-orange-600 px-4 md:px-7 py-2.5 rounded active:scale-96 transition-all text-white uppercase font-semibold">
          Subscribe
          <FaArrowRight />
        </button>
      </div>
